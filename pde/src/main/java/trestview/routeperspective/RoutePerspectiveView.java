...
//----------------------------------------------------------------------------------------------------------------------
        MVC tableSubject_labourMVC  = new MVC (TableModel.class, TableController.class, TableViewP.class, observableDS, Rule.Subject_labour );
...
//----------------------------------------------------------------------------------------------------------------------
        MVC tableRouteMVC  = new MVC (TableModel.class, TableController.class, TableViewP.class,observableDS, Rule.Route );
