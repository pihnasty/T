...
public class VConConveyorPdeView extends BorderPaneObserverDS {
    ...
    public  VConConveyorPdeView(ObservableDS observebleDS, InitializableDS initializableDS){
        ...
        FXMLLoader fxmlLoader = XmlRW.fxmlLoad(this,initializableDS, "trestview/tasks/conveyorPDE/v_const/vConConveyorPdeView.fxml","ui", "trestview/tasks/conveyorPDE/v_const/vConConveyorPdeStyle.css");
