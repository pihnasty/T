...
import trestview.orderplaninigperspective.schemabase.SchemaBaseModel;
...
public class SchemaOrderPlaninigModel extends SchemaBaseModel {
    ...
    public SchemaOrderPlaninigModel(ObservableDS observableDS, Rule rule) {
